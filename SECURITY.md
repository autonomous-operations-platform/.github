...
Instead, please report them via the SAP Trust Center at [https://www.sap.com/about/trust-center/security/incident-management.html](https://www.sap.com/about/trust-center/security/incident-management.html) or use the [**GitHub private security advisory**](https://github.com/autonomous-operations-platform/.github/security/advisories/new) feature of the affected repository. You can find it under the "Security" tab - "Report a vulnerability".
